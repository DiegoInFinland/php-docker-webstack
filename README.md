...
I did this mostly to group and manage my many unfinished or experimental PHP projects in a more meaningful way. I often use it when I need to do something in PHP.
...
- To check some Links (right panel) to some usefull resources. Also a (PHP, Python, etc) documentation links but they're hosted in my personal computer.
  Too heavy to upload here so they are in .gitignore. Again, feel free to edit or delet it if you don't want it. 
...
This is mostly a development environment so more secure setup and better frontend is needed for a production setup. Please, adapt it at your own use case!
...
Good practices tell us that allways is better one service per container, however in this particular case having apache:php helps to quickly deploy a container that can handle most PHP frameworks like Laravel or Symfony from the scratch. Again, adapt it at your own use case.
